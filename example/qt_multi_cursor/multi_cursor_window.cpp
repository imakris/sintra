...
private:
    ...
    std::array<ghost_cursor_t, sintra_example::k_num_windows> m_ghost_cursors;
    std::array<window_state_t, sintra_example::k_num_windows> m_window_states;
