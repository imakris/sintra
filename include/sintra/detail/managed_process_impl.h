...
inline
void Managed_process::wait_for_delivery_fence(Process_message_reader* exclude_request_reader)
{
...

    {
        ...
        for (auto& [process_id, reader_ptr] : m_readers) {
            ...
            const bool skip_request_stream =
                (exclude_request_reader != nullptr) && (reader_ptr.get() == exclude_request_reader);
