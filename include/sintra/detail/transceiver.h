...
//////   \//////   \//////   \//////   \//////   \//////   \//////   \//////
 ////     \////     \////     \////     \////     \////     \////     \////
  //       \//       \//       \//       \//       \//       \//       \//
    ...
    // Short note: Message bodies use sintra::detail::message_args instead of std::tuple so that the
    // arguments live as direct data members. This keeps the compact layout that the original
    // boost::fusion::vector implementation provided.
    ...
    {
        using args_type = serializable_type<detail::message_args<Args...>>;
